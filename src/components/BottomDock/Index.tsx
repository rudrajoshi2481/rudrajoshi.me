...
import { Dock, DockIcon } from "../../../shadcomponents/magicui/dock";
...
export function BottomDock() {
  return (
    <div className="  flex h-0 w-full justify-center items-center">
        <div className=" bottom-5 w-auto  shadow-2xl z-50 border-2 border-gray-300 bg-white">
      <Dock direction="top">
        <DockIcon className="m-4">
